...
public class CEPTextEdit extends EditText {
	...
	public CEPTextEdit(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initialize();

	}

	public CEPTextEdit(Context context, AttributeSet attrs) {
		super(context, attrs);
		initialize();

	}

	public CEPTextEdit(Context context) {
		super(context);
		initialize();
	...
	public String getCleanText() {
		String text = CEPTextEdit.this.getText().toString();
	...
	private void initialize() {
		...
		this.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				 ...
				 */
				isUpdating = true;
				CEPTextEdit.this.setText(cep);

				CEPTextEdit.this.setSelection(positioning[length]);
